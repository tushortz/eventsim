...
# -*- coding: utf-8 -*-
#
# eventsim documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'eventsim.tex', 'eventsim Documentation',
   'Taiwo Kareem', 'manual'),
]
...
man_pages = [
    (master_doc, 'eventsim', 'eventsim Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'eventsim', 'eventsim Documentation',
   author, 'eventsim', 'One line description of project.',
   'Miscellaneous'),
]
